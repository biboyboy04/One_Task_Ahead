...
--
-- Host: 127.0.0.1
-- Generation Time: May 19, 2023 at 11:49 PM
...
(0, 1, 0, 5, 'Gather equipment (camera, lenses, tripod, etc.)', 'heyy\nasdzxc', 'done', 1),
...
INSERT INTO `task` (`task_id`, `Title`, `Description`, `Lane`, `temp_id`, `customized`, `number`) VALUES
...
--
ALTER TABLE `task`
  MODIFY `task_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1208;
...
ALTER TABLE `edited_template_task`
  ...
  ADD CONSTRAINT `edited_template_task_ibfk_2` FOREIGN KEY (`task_id`) REFERENCES `task` (`task_id`);
